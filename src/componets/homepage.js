        ...
        <div ref={HomeRef} className='flex flex-row justify-between max-sm:justify-start max-sm:flex-col'>
            <div className='px-10 max-sm:px-5  flex flex-row max-sm:flex-col   justify-between max-sm:justify-start max-sm:gap-[50px]  animate-[fadeIn_1s_forwards]  pt-[100px] max-sm:py-[20px]  max-md:mt-[5vh] max-md:mb-[5vh]'>
                <div className=' text-white w-[100%]  max-md:px-[5%] flex flex-col gap-4 text-left max-sm:w-[100%] '>
                    <p>Hi, my name is</p>
                    <p className='text-[3.5rem] font-bold  animate-[leftToRight_1.5s_forwards] '>Himanshu {''}
                        <span className='text-p-300   pt-2 overflow-x-hidden '>Singh Jani.</span></p>
                    ...
                    <div className='flex flex-row gap-5 mt-5 max-md:mt-3'>
                        <AiFillInstagram className='text-4xl text-gray-400 hover:text-gray-200 cursor-pointer ' onClick={() => { window.open("https://www.linkedin.com/in/himanshu-jani-589b92256/", "_blank") }} />
                        <AiFillLinkedin className='text-4xl text-gray-400 hover:text-gray-200 cursor-pointer ' onClick={() => { window.open("https://www.linkedin.com/in/himanshu-jani-589b92256/", "_blank") }} />
                        <AiOutlineWhatsApp className='text-4xl text-gray-400 hover:text-gray-200 cursor-pointer ' onClick={() => { window.open("https://api.whatsapp.com/send?phone=9873267682", "_blank") }} />
                    </div>
                </div>

            </div>
            <div className='w-[45%] max-sm:w-[100%] p-5'>
                <img loading='lazy' alt='my-pic' src='/Himanshu.jpg' className=' p-2 mt-10 rounded-[50%] border-2 object-contain float-right max-sm:float-none max-sm:m-auto'></img>
            </div>
        </div>
    )
}
